...
from nect_app.forms import Admin_User_Form,Common_User_Form,Admin_User_AddForm,Common_User_AddForm
from django.http import HttpResponse,HttpResponseRedirect
from django.contrib.auth.decorators import login_required
from django.urls import reverse
from django.contrib.auth import authenticate,login,logout
from nect_app.models import Admin_User,Common_User
...
def registerStudent(request):
    ...
    if request.method=='POST':
        var_studentForm=Admin_User_Form(request.POST)
        var_studentAddForm=Admin_User_AddForm(request.POST)
