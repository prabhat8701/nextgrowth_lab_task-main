...
from next_app.forms import Admin_User_Form,Common_User_Form,Admin_User_AddForm,Common_User_AddFormfrom django.http import HttpResponse,HttpResponseRedirect
