...
class AndroidApp(models.Model):
    ...
    Applink = models.URLField()  # Assuming it stores a link to the app
    App_category = models.CharField(max_length=50)
    Sub_category = models.CharField(max_length=50)
    App_img = models.ImageField(upload_to='App_img/')  # Fixed typo in field name
    points = models.PositiveIntegerField()

    def __str__(self):
        return self.Appname  # Corrected the field name to 'Appname'
